        ...
        return (
            <form className="register-form" method="post">
                <div className="form-title">
                    <span className="form-title">Системд бүртгүүлэх</span>
                </div>
                <p className="hint"> Хувийн мэдээлэл: </p>
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Нэр</label>
                ...
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Гэрийн хаяг</label>
                    <input className="form-control placeholder-no-fix" type="text" placeholder="Address" name="address" /> </div>
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Хот/Аймаг</label>
                    <input className="form-control placeholder-no-fix" type="text" placeholder="City/Town" name="city" /> </div>
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Улс</label>
                ...
                <p className="hint"> Системд хэрэглэгдэх хэрэглэгчийн мэдээлэл: </p>
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Хэрэглэгчийн нэр</label>
                ...
                <div className="form-group">
                    <label className="control-label visible-ie8 visible-ie9">Нууц үг (давтан бичих)</label>
                ...
                <div className="form-actions">
                    <button type="button" id="register-back-btn" className="btn btn-default">Буцах</button>
                    <button type="submit" id="register-submit-btn" className="btn red uppercase pull-right">Намайг бүртгэ!</button>
                </div>
            </form>
        )
    }
